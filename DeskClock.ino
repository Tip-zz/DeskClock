...
const uint8_t fontP[] PROGMEM = {
                      ...
                      0x42,   0xC3,   0xDB,   0xFF,   0x66, 
                      0x1F,   0x1F,   0x18,   0xFF,   0xFF, 
                      0x5F,   0xDF,   0xDB,   0xFB,   0x73, 
                      0x7E,   0xFF,   0xDB,   0xFB,   0x72, 
                      0xE3,   0xF3,   0x1B,   0x0F,   0x07, 
                      0x76,   0xFF,   0xDB,   0xFF,   0x76, 
                      0x4E,   0xDF,   0xDB,   0xFF,   0x7E, 
                      0x66,   0x66,   0x00,   0x00,   0x00, 
                      0xF8,   0xFC,   0x36,   0xFC,   0xF8, 
                      0xFE,   0xFE,   0x36,   0x3E,   0x1C, 
                      0xFE,   0xFC,   0x18,   0xFC,   0xFE, 
...
// Thin font
                      ...
                      0x0F,   0x08,   0x08,   0x08,   0xFF, 
                      0x4F,   0x89,   0x89,   0x89,   0x71, 
                      0x7E,   0x91,   0x89,   0x89,   0x72, 
                      0xE1,   0x11,   0x09,   0x05,   0x03, 
                      0x76,   0x89,   0x89,   0x89,   0x76, 
                      0x46,   0x89,   0x89,   0x89,   0x7E, 
                      0x24,   0x00,   0x00,   0x00,   0x00, 
                      0xF8,   0x14,   0x12,   0x14,   0xF8, 
...
// Default paramrters
const float d_sBrite = 1000.0;  // clip ambient ADC here
const float d_bBrite = 0.0;     // ambient ADC offset
...
const byte bits[8] = {0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80};
int didxidx;
...
// Update brightness
    ...
    if (g_ADC > p.sBrite) g_ADC = p.sBrite;   // ADC saturates at p.sBrite
    b_brite = p.bBrite + g_ADC * (16-p.bBrite)/(p.sBrite+1);
